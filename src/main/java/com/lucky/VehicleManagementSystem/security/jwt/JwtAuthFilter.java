...
import com.lucky.VehicleManagementSystem.exceptions.TokenException;
import com.lucky.VehicleManagementSystem.security.user.CustomUserDetailsService;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        JwtExtractedUser jwtExtractedUser = null;
        ...
        try {
            jwtExtractedUser = jwtUtils.decodeToken(jwtToken);
        } catch (JWTVerificationException e) {
            throwErrors(request, response, filterChain, e);
            return;
        }

        if (jwtExtractedUser.getEmail() != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            try {
                UserPrincipal userPrincipal = (UserPrincipal) customUserDetailsService.loadUserByUsername(jwtExtractedUser.getEmail());
